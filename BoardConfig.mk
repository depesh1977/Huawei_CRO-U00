...
BOARD_MKBOOTIMG_ARGS  := --kernel_offset 0x00008000 --ramdisk_offset 0x04000000 --tags_offset 0x0e000000 --board B102
TARGET_PREBUILT_KERNEL := device/huawei/CRO_U00/prebuilt/kernel
...
# RECOVERY
TARGET_RECOVERY_FSTAB := device/huawei/CRO_U00/recovery/root/etc/recovery.fstab
